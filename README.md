...
- Никакого ClickHouse, Kafka, Cassandra на старте.
...
Перед погружением в детали явно фиксируется, что система гарантирует и от чего отказывается. Дальнейшие решения вытекают из этого контракта.
